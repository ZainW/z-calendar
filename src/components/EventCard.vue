<template>
  ...
  >
    ...
    <div class="event-details">
      <div class="detail-section">
        ...
        <p class="time">
          ...
          <button class="time-button" @click="showRescheduleModal = true">
    ...
    <div class="event-actions">
      <button class="action-button primary" @click="showRescheduleModal = true">
        Reschedule
      </button>
...
function handleReschedule(newDate: Date) {
  showRescheduleModal.value = false;
  if (props.event) {
    emit('reschedule', { ...props.event, start: newDate });
  }
}
